...
class ForecastModel:
    ...
    def __init__(self, params: Optional[Dict[str, Any]] = None):
        ...
        self._max_features = self.params.get("max_features", "sqrt")  # sklearn default
        ...
        # Read seed from params (fallback: 42)
    ...
    def _clean(X):
        ...
        # Final safety pass before fitting/predicting
